...
from dynime.dynime_settings import DYNAMIC_URL_PATTERNS, HORILLA_DATE_FORMATS
from dynime.http import HorillaRedirect
from dynime.methods import remove_dynamic_url
...
def validate_bulk_attendance(request):
    ...
    for obj_id in ids:
        try:
            ...
            # Fixes: https://github.com/dynime/dynime-hr/issues/1055
