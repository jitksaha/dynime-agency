...
from dynime_audit.methods import remove_duplicate_history
...
def pre_create_dynime_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_dynime_audit_log(sender, instance, *_args, **kwargs):
    """
