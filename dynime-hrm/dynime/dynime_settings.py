...
from dynime.dynime_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=dynime,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="dynime"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=dynime,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from dynime_ldap.models import LDAPSettings
