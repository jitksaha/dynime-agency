...
This module is used to register dynime addons
"""

from dynime import settings
from dynime.settings import INSTALLED_APPS

INSTALLED_APPS.append("accessibility")
INSTALLED_APPS.append("dynime_audit")
INSTALLED_APPS.append("dynime_widgets")
INSTALLED_APPS.append("dynime_crumbs")
INSTALLED_APPS.append("dynime_documents")
INSTALLED_APPS.append("dynime_views")
INSTALLED_APPS.append("dynime_automations")
INSTALLED_APPS.append("auditlog")
INSTALLED_APPS.append("biometric")
INSTALLED_APPS.append("helpdesk")
INSTALLED_APPS.append("offboarding")
INSTALLED_APPS.append("dynime_backup")
