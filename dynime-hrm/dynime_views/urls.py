"""
dynime_views/urls.py
"""

from django.urls import path

from dynime_views import views
from dynime_views.generic.cbv import history
from dynime_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "dynime-history-revert/<int:pk>/<int:history_id>/",
