...
from dynime.filters import FilterSet
from dynime.group_by import group_by_queryset
from dynime.dynime_middlewares import _thread_locals
from dynime.http.response import HorillaRedirect
from dynime.signals import post_generic_import, pre_generic_import
from dynime_views import models
from dynime_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from dynime_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from dynime_views.templatetags.generic_template_filters import getattribute
...
class HorillaListView(ListView):
    ...
    template_name: str = "generic/dynime_list_table.html"
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        from dynime.urls import path, urlpatterns
...
class HorillaSectionView(TemplateView):
    ...
    template_name = "generic/dynime_section.html"
...
class HorillaDetailedView(DetailView):
    ...
    title = "Detailed View"
    template_name = "generic/dynime_detailed_view.html"
    header: dict = {
        "title": "Horilla",
...
class HorillaTabView(TemplateView):
    ...
    template_name = "generic/dynime_tabs.html"
...
class HorillaCardView(ListView):
    ...
    template_name = "generic/dynime_card.html"
    context_object_name = "queryset"
...
class HorillaFormView(FormView):
    ...
    template_name = "generic/dynime_form.html"
    ids_key: str = "instance_ids"
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "dynime_widgets/select_option.html",
                    )
...
class HorillaNavView(TemplateView):
    ...
    template_name = "generic/dynime_nav.html"
...
class HorillaProfileView(DetailView):
    ...
    template_name = "generic/dynime_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
