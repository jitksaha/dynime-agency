"""
dynime_views/generic/cbv/history.py
"""
...
from dynime_views.cbv_methods import hx_request_required
from dynime_views.generic.cbv.views import HorillaFormView
from dynime_views.history_methods import get_diff
...
class HorillaHistoryView(DetailView):
    ...
    template_name = "generic/dynime_history_view.html"
