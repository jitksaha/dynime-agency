...
class HorillaAutomationConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            from base.templatetags.dynimefilters import app_installed
            from employee.models import Employee
            from dynime_automations.methods.methods import get_related_models
            from dynime_automations.models import MODEL_CHOICES
            ...
            try:
                from dynime_automations.signals import start_automation
