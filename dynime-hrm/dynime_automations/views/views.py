"""
dynime_automation/views/views.py
"""
...
from dynime_automations.methods.methods import generate_choices
from dynime_automations.methods.serialize import serialize_form
from dynime_automations.models import MailAutomation
from dynime_automations.signals import REFRESH_METHODS
from dynime_views.generic.cbv.views import HorillaFormView
...
@login_required
@permission_required("dynime_automations.delete_mailautomation")
...
@login_required
@permission_required("dynime_automations.add_mailautomation")
