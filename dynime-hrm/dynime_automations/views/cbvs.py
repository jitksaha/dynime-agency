"""
dynime_automations/views/cbvs.py
"""
...
from dynime.decorators import login_required, permission_required
from dynime_automations import models
from dynime_automations.filters import AutomationFilter
from dynime_automations.forms import AutomationForm
from dynime_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("dynime_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.HorillaSectionView):
    ...
    template_name = "dynime_automations/section_view.html"
...
class AutomationNavView(views.HorillaNavView):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("dynime_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("dynime_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.HorillaFormView):
    ...
    template_name = "dynime_automations/automation_form.html"
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("dynime_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "dynime_automations/load_automation.html"
