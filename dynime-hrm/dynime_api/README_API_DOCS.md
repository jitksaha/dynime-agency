# Dynime API Documentation

This document provides information on how to use and maintain the API documentation for Dynime HRMS.
...
```python
from dynime_api.docs import document_api
...
- Module tags are defined in `dynime_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `dynime_api/urls.py`
