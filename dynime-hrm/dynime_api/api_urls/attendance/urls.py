"""
dynime_api/urls/attendance/urls.py
"""

from django.urls import path

from dynime_api.api_views.attendance.permission_views import AttendancePermissionCheck
from dynime_api.api_views.attendance.views import *
