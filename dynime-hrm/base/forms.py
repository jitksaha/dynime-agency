...
from dynime_audit.models import AuditTag
from dynime_widgets.widgets.dynime_multi_select_field import HorillaMultiSelectField
from dynime_widgets.widgets.select_widgets import HorillaMultiSelectWidget
...
class EmployeeShiftScheduleUpdateForm(ModelForm):
    ...
    def as_p(self):
        ...
        context = {"form": self}
        table_html = render_to_string("dynime_form.html", context)
        return table_html
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_dynime_model_class(app_label="leave", model="leavetype")
