...
from dynime.dynime_apps import TWO_FACTORS_AUTHENTICATION
from dynime.dynime_settings import APPS
from dynime.methods import get_dynime_model_class
from dynime_documents.models import DocumentRequest

CACHE_KEY = "dynime_company_models_cache_key"
...
class CompanyMiddleware:
    ...
    def _add_company_filter(self, model, company_id):
        ...
        is_dynime_manager = isinstance(model.objects, HorillaCompanyManager)
        ...
        if is_company_model:
            ...
            elif is_dynime_manager and related_company_field:
                model.add_to_class(
            ...
            for app_label, models in app_model_mappings.items():
                if apps.is_installed(app_label):
                    company_models.extend(
                        [get_dynime_model_class(app_label, model) for model in models]
                    )
