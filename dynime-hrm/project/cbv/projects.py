...
from dynime_views.cbv_methods import login_required, permission_required
from dynime_views.generic.cbv.views import (
    HorillaCardView,
    HorillaFormView,
    HorillaListView,
    HorillaNavView,
...
# Remove the command lines after dynime converted into CBV
