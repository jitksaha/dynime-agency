...
from dynime_widgets.forms import HorillaForm, default_select_option_template
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(dynime_middlewares._thread_locals, "request", None)
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_dynime_model_class(
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_dynime_model_class("leave", "availableleave")
