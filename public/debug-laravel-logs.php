...
// Force request URI path matching to /api/v1/jobs (which corresponds to v1/jobs inside route:list because api prefix is prepended)
$request = Illuminate\Http\Request::create('/api/v1/jobs', 'GET');

try {
    echo "<h3>Sending Request to /api/v1/jobs...</h3>";
