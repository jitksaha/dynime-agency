...
// Force request URI path matching to /api/v1/jobs on live system
$request = Illuminate\Http\Request::create('http://dynime.com/dynime-api/public/api/v1/jobs', 'GET');

try {
    echo "<h3>Sending Request to public jobs api...</h3>";
