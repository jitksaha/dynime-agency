<?php
// Secure temporary script to update .env to use https://apis.flowmingo.ai/company
$token = 'update_token_3892';
...
echo "Successfully updated .env file keys to use apis.flowmingo.ai/company URL.<br/>";
