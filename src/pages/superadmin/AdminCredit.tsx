...
import { Loader2, Check, X, HelpCircle, MessageSquare } from "lucide-react";
  ...
  return (
    <SuperAdminLayout>
      ...
      <WhatsAppSendDialog
        ...
        recipientPhone={whatsAppTarget?.profiles?.phone || ""}
        recipientName={whatsAppTarget?.profiles?.email || ""}
        defaultTemplateKey="credit_application"
        defaultVars={{
          0: whatsAppTarget?.profiles?.email || "",
          1: whatsAppTarget?.status || "pending",
        }}
      />
    </SuperAdminLayout>
  );
